...
public class MapEditorPanel extends JPanel {
    ...
    public ArmyColor getSelectedColor() {
        if (selectedColorButton == null) {
            return null;
        }
        return selectedColorButton.getColor();
    }
    ...
    public Terrain getSelectedTerrain() {
        if (selectedTerrainButton == null) {
            return null;
        }
        return selectedTerrainButton.getTerrain();
    }
    ...
    public Piece getSelectedPiece() {
        ...
        return selectedPieceButton.getPiece();
    }
